...
public class BoardController {
	...
	@GetMapping("/board/index.do") //핸들러매핑이 찾기
	public String index(Model model, HttpServletRequest req, BoardVo vo) { //커맨드객체를 자동으로 바운딩?
...
//		model.addAttribute("word", searchWord); 
	...
	public String insert(BoardVo vo, HttpServletRequest req, MultipartFile file) { //커맨드 객체방식으로(BoardVo vo), file과 jsp의 name이 같아야
